...
export function CategoriesOverviewStats() {
  return (
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      <StatCard title="Tổng danh mục" value="12" subtext="Đã tạo" icon={<FolderOpen className="h-6 w-6" />} />
      <StatCard title="Đang hiển thị" value="10" subtext="Active" icon={<Eye className="h-6 w-6" />} />
