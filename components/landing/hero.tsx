    ...
    <section className="relative overflow-hidden border-b border-slate-800/50 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="relative container mx-auto px-4 py-20 md:py-32">
        <div className="mx-auto max-w-4xl text-center">
          {/* Headline */}
          <h1 className="text-4xl leading-tight font-bold text-balance text-white md:text-5xl lg:text-6xl">
          ...
          {/* Subheadline */}
          <p className="mx-auto mt-6 max-w-2xl text-lg text-pretty text-slate-300 md:text-xl">
          ...
          {/* Social Proof */}
          <div className="mt-16">
            <p className="text-sm text-slate-400">Được tin dùng bởi các nhà hàng hàng đầu</p>
            <div className="mt-6 flex flex-wrap items-center justify-center gap-8 opacity-60 grayscale">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="flex h-12 w-32 items-center justify-center rounded-lg bg-slate-800/50"
                >
                  <span className="text-sm text-slate-400">Logo {i}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-3">
            <div>
              ...
              <div className="mt-2 text-sm text-slate-400">Thời gian xử lý order</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-emerald-400">-85%</div>
              <div className="mt-2 text-sm text-slate-400">Sai sót đơn hàng</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-emerald-400">+60%</div>
              <div className="mt-2 text-sm text-slate-400">Tốc độ phục vụ bàn</div>
            </div>
          </div>
        </div>
      </div>
