...
const roles = [
  {
    ...
    icon: Crown,
    label: "Chủ nhà hàng",
    painPoints: ["Khó theo dõi doanh thu realtime", "Sai sót order gây phàn nàn", "Khó quản lý nhiều bàn cùng lúc"],
    solutions: [
  ...
  },
  {
    ...
    icon: Calculator,
    label: "Thu ngân",
    painPoints: ["Order viết tay dễ sai sót", "Tính tiền lâu, khách chờ lâu", "Khó đối chiếu cuối ca"],
  ...
  },
  {
    ...
    icon: UserCheck,
    label: "Phục vụ",
    painPoints: ["Chạy qua lại ghi order", "Khách gọi nhiều, không kịp", "Quên order, bàn nào order gì"],
    solutions: ["Khách tự order qua QR", "Nhận thông báo order mới realtime", "Xem lịch sử order từng bàn"],
  },
  {
    id: "chef",
    icon: ChefHat,
    label: "Bếp",
    painPoints: ["Order viết tay khó đọc", "Không biết ưu tiên món nào", "Bỏ sót order khi quá tải"],
