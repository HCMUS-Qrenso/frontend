    ...
    >
      <div className="flex items-start justify-between gap-2">
        <div>
          ...
          <p
            className={cn(
              'mt-2 font-semibold tracking-tight text-slate-900 dark:text-white',
              valueSz,
            )}
          >
            {value}
        ...
        <div
          className={cn(
            `flex h-${iconSz * 2} w-${iconSz * 2} aspect-square items-center justify-center rounded-${iconRounded}`,
            iconBgColor,
          )}
        >
