...
const features = [
  {
    ...
    description:
      'Theo dõi orders, doanh thu, bàn trống realtime. Analytics chi tiết theo ngày/tuần/tháng.',
  },
  {
    icon: QrCode,
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mb-16 text-center">
            <h2 className="text-3xl font-bold text-slate-900 md:text-4xl dark:text-white">
              Tính năng hoàn chỉnh cho nhà hàng hiện đại
            </h2>
            <p className="mt-4 text-lg text-slate-500 dark:text-slate-400">
              Từ đặt món đến thanh toán, từ bếp đến quản lý
            </p>
          </div>
