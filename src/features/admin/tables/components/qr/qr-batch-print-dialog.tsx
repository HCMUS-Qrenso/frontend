...
import { downloadBlob } from '@/src/lib/helpers/download'
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg rounded-3xl">
        <DialogHeader>
          <DialogTitle>In hàng loạt mã QR</DialogTitle>
          <DialogDescription>Tạo file PDF để in hàng loạt QR code cho bàn</DialogDescription>
        </DialogHeader>
